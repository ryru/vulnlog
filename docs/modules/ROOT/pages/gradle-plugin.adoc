...
Run with `gradle --info` to see parsed inputs, filter resolution, written outputs, and skipped suppression entries; `gradle --debug` adds debug detail.
...
See xref:cli-fmt.adoc[`vulnlog fmt`] for the formatting rules.
